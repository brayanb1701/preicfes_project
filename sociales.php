			...
			<div class="row">
				<div class="col">
					<div class="regular_content">
						<div class="regular_title">Ciencias Sociales</div>
						<div class="regular_text"><form action="conexion2.php" method="post">
							<p>1. <!-- Primera Pregunta-->  ¿De qué color era el caballo blanco de Simon Bolivar?
							<br>
  							<input type="radio"  id="a3" name="m1" value="0">Gris<br>
  							<input type="radio"  id="a1" name="m1" value="0">Marron<br>
							<!-- Opcion correcta--><input type="radio"  id="a2" name="m1" value="1">Blanco<br>
  							<input type="radio"  id="a4" name="m1" value="0">Negro<br>
							</p>
							<p>2. <!-- Pregunta-->
							<br>
							...
							<input type="hidden" value="sociales" name="materia">
