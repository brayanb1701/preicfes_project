			...
			<div class="row">
				<div class="col">
					<div class="regular_content">
						<div class="regular_title">Ingles</div>
						<div class="regular_text"><form action="conexion2.php" method="post">
							<p>1. <!--Primera Pregunta--> ¿What's the meaning of "what"?
							<br>
							<!-- Opcion correcta--><input type="radio"  id="a2" name="m1" value="1">Que<br>
  							<input type="radio"  id="a3" name="m1" value="0">Donde<br>
  							<input type="radio"  id="a1" name="m1" value="0">Cuando<br>
  							<input type="radio"  id="a4" name="m1" value="0">Como<br>
							</p>
							<p>2. <!-- Pregunta-->
							<br>
							...
							<input type="hidden" value="ingles" name="materia">
