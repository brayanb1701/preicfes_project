			...
			<div class="row">
				<div class="col">
					<div class="regular_content">
						<div class="regular_title">Ciencias Naturales</div>
						<div class="regular_text"><form action="conexion2.php" method="post">
							<p>1. <!-- Primera Pregunta--> Aquí va la primera pregunta: La vaca hace... 
							<br>

  							<input type="radio"  id="a3" name="m1" value="0">croack<br>
  							<input type="radio"  id="a1" name="m1" value="0">guau<br>							
							<!-- Opcion correcta--><input type="radio"  id="a2" name="m1" value="1">muu<br>
  							<input type="radio"  id="a4" name="m1" value="0">miau<br>
							</p>
							<p>2. <!-- Pregunta-->
							<br>
							...
							<input type="hidden" value="ciencias" name="materia">
