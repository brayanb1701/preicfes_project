			...
			<div class="row">
				<div class="col">
					<div class="regular_content">
						<div class="regular_title">Matemáticas</div>
						<div class="regular_text">
						<form action="conexion2.php" method="post">
							<p>1. <!-- Primera Pregunta--> 2+2=
							<br>
							<!-- Opcion correcta--><input type="radio"  id="a2" name="m1" value="1">4<br>
  							<input type="radio"  id="a3" name="m1" value="0">0<br>
  							<input type="radio"  id="a1" name="m1" value="0">-1<br>
  							<input type="radio"  id="a4" name="m1" value="0">Pez<br>
							</p>
							<p>2. <!--Pregunta-->
							<br>
							...
							<input type="hidden" value="matematicas" name="materia">
